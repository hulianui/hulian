...
export const magicCardShowcase: ShowcaseSpec = {
  ...
  <div className="flex h-full flex-col items-center justify-center gap-1 p-6">
    ...
    <span className="text-sm text-muted-foreground">Move the mouse up to see the highlight</span>
  </div>
</MagicCard>`,
            render: () => (<MagicCard className="h-44 w-72">
          <div className="flex h-full flex-col items-center justify-center gap-1 p-6">
            <span className="text-lg font-semibold text-foreground">Magic Card</span>
            <span className="text-sm text-muted-foreground">Move the mouse up to see the highlights</span>
          </div>
        </MagicCard>),
        },
        {
  ...
  <div className="flex h-full items-center justify-center p-6">
    <span className="text-sm text-muted-foreground">Bigger and brighter highlights</span>
  </div>
</MagicCard>`,
  ...
  <div className="flex h-full items-center justify-center p-6">
    <span className="text-sm text-muted-foreground">Change to a highlight color</span>
  </div>
</MagicCard>`,
