...
const modules: TransferItem[] = [
    ...
    { key: "coupon", label: "Marketing activities", description: "Coupons and discounts" },
    { key: "finance", label: "Financial Reconciliation", description: "Statement and Settlement Statement" },
