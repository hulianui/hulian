...
export const beianFooterShowcase: ShowcaseSpec = {
    examples: [
        {
            title: "Basic usage",
            description: "Pass in a single registration number ICP, and the default link will be to the Ministry of Industry and Information Technology registration system.",
            code: `<BeianFooter icp={[{ number: "Fujian ICP No. 2024073556-1" }]} />`,
...
/>`,
        ...
        },
        {
            ...
            description: "When police is entered, the police badge icon is displayed, and the default link is to the Ministry of Public Security filing system.",
            code: `<BeianFooter
...
/>`,
    ...
    toCode: () => `<BeianFooter
  icp={[{ number: "Fujian ICP No. 2024073556-1" }, { number: "Fujian ICP No. 2024073556-2" }]}
  police={{ number: "Fujian Public Network Security No. 35030302900030" }}
  copyright="\u00A9 2026 Hulian \u00B7 Abel"
/>`,
};
