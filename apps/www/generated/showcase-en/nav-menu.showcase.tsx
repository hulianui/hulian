        ...
        children: [
            {
                ...
                icon: <Users />,
                children: [
                    { key: "users-list", label: "User List", href: "https://example.com/#users-list" },
                    { key: "users-roles", label: "Role permissions", href: "https://example.com/#users-roles" },
                    { key: "users-audit", label: "Operational Audit", href: "https://example.com/#users-audit" },
                ],
            },
            {
                key: "content",
                ...
                icon: <FileText />,
                children: [
                    { key: "content-posts", label: "Article", href: "https://example.com/#content-posts" },
                    {
        ...
        children: [
            {
                ...
                children: [
                    ...
                    { key: "sys-user-list", label: "User List", href: "https://example.com/#user-list" },
                ],
            },
            {
                key: "sys-log",
                label: "Log",
                children: [
                    { key: "sys-log-login", label: "Login log", href: "https://example.com/#log-login" },
                    { key: "sys-log-error", label: "Error log", href: "https://example.com/#log-error" },
                ],
            },
        ],
    },
