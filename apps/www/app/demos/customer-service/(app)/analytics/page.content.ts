...
export const content = {
  ...
  en: {
    "onlineAgent": "Agents online",
    "queuing": "Waiting",
    "inProgress": "In progress",
    "todayIsOver": "Resolved today",
    "dataDashboard": "Data dashboard",
    "realTimeMeasurementOfServiceQualityAnd": "Monitor service quality and agent performance in real time. Demo data resets on reload.",
