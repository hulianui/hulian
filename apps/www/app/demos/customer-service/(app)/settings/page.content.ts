...
export const content = {
  ...
  en: {
    "xiaoLian": "Xiao Lian",
    "iMHappyToServeYouIf": "I'm happy to serve you. If you have any questions, feel free to contact me~",
    "helloIAmYourDedicatedCustomerService": "Hello, I am your dedicated customer service Xiao Lian. How can I help you?",
    "settingsSaved": "Settings saved",
    "customerServicePreferencesHaveBeenUpdatedDemo": "Customer service preferences have been updated (stored in memory for this demo; reload to restore)",
    "customerServiceSettings": "Customer service settings",
    "configureAgentReceptionPreferencesAndAutomationRules": "Configure agent reception preferences and automation rules.",
    ...
    "dialogWindowSubtitleDisplay": "Dialog window subtitle display",
    "oneSentenceSignature": "one sentence signature",
    ...
    "sessionsExceedingTheUpperLimitAreQueued": "Sessions exceeding the upper limit are queued",
    "automaticallyTransferAfterLeaving": "Automatically transfer after leaving",
    "transferTheOngoingConversationToAnotherPerson": "Transfer the ongoing conversation to another person when the status switches to \"Break\"",
    "automaticallyTransferAfterLeaving2": "Automatically transfer after leaving",
    "automaticReply": "automatic reply",
    "enableWelcomeMessage": "Enable welcome message",
    "automaticallySendAWelcomeMessageWhenThe": "Automatically send a welcome message when the customer logs in",
    "enableWelcomeMessage2": "Enable welcome message",
    "welcomeMessageContent": "Welcome message content",
    "automaticallySentWhenTheCustomerAccesses": "Automatically sent when the customer accesses...",
    "workingHours": "working hours",
    "receptionHours": "Support hours",
    "intelligentAssistantsWillBeOnDutyDuring": "Intelligent assistants will be on duty during non-working hours",
    "localizedText": "7×24",
