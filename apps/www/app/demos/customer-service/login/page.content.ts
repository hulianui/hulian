...
export const content = {
  ...
  en: {
    ...
    "webPageAppWechatPhoneOneWorkbench": "Handle web, app, WeChat, and phone conversations from one workbench",
    ...
    "realTimeTrackingOfFirstCallDuration": "Track first-response time, resolution rate, and CSAT in real time",
    "coral": "Hulian",
    "hulianCustomerService": "Hulian Support",
    "makeEveryConversation": "Make every conversation",
    "areTakenSeriously": "count",
    "aRealTimeConversationalWorkbenchForAgents": "A real-time support workbench with a unified inbox, ticket handoffs, knowledge retrieval, and service analytics.",
    "hulianBuiltInExamples": "© 2026 Hulian · Built-in example",
    "coral2": "Hulian",
    "hulianCustomerService2": "Hulian Support",
    "welcomeBackLogInToYourCustomer": "Welcome back. Sign in to your support workbench.",
    "forgotPassword": "Forgot password",
    "contactAdministrator": "Contact administrator",
    "demoEnvironmentFillInAnyUsernamePassword": "Demo environment: Enter any username and password to sign in",
  },
} as const;
