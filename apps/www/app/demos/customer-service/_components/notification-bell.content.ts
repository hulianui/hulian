...
export const content = {
  ...
  en: {
    ...
    "zhaoTiezhuInitiatedConsultationThroughTheWeb": "Zhao Tiezhu started a web conversation and is waiting for an agent.",
    "justNow": "just now",
    "workOrderAssigned": "Ticket assigned",
    "tAppWasNotShippedAfterOrdering": "#T-2093 \"Order has not shipped\" was assigned to you",
    "minutesAgo": "3 minutes ago",
    "receivedPositiveReviewsFromCustomers": "New customer rating",
    "linWanruGaveThisServiceAStar": "Lin Wanru gave this service a 5-star rating ⭐",
    "minutesAgo2": "12 minutes ago",
    "valueUnreadItems": "({0} unread)",
