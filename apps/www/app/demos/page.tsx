...
import { demoMeta, demos } from "./lib/demos";
    ...
    <main className="mx-auto max-w-5xl px-6 py-16">
      <header className="mb-10">
        <Heading level={1} size="3xl">
          {DOCS_LOCALE === "en" ? "Built-in demos" : "内置模版"}
        </Heading>
        <Text tone="muted" className="mt-2">
          {DOCS_LOCALE === "en"
            ? "Complete product scenarios built with @hulianui/ui and refined through dogfooding."
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {d.status === "wip" && (
                      <Tag tone="warning" size="sm" dot pulse>
                        {DOCS_LOCALE === "en" ? "In progress" : "建设中"}
                      </Tag>
                    )}
                  </div>
