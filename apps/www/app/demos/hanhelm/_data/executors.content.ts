...
export const content = {
  ...
  en: {
    ...
    "anthropicBalanceTheMainForce": "Anthropic · Balanced general-purpose model",
    "anthropicFlagshipReasoning": "Anthropic · Flagship reasoning",
    "inDepthExplorationUltraLowCost": "Deep reasoning · Very low cost",
    "coralPictureScrollFlux": "Hulian Image Flux",
    "imageGenerationHighFidelity": "Image generation · High fidelity",
    "retrievalEnhancementAgent": "Retrieval enhancement agent",
    "ragVectorLibraryRearrangement": "RAG · Vector search and reranking",
    "contentReviewAgent": "Content Review Agent",
    "complianceReviewMultipleStrategiesRunInParallel": "Compliance review · Parallel policy checks",
    "orchestrationAndSchedulingAgents": "Orchestration Agent",
    "multiAgentOrchestrationPlanExecuteSummarize": "Multi-agent orchestration · Plan-execute-summarize",
    "structuredExtractionOfAgents": "Structured Extraction Agent",
