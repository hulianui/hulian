...
export const content = {
  ...
  en: {
    ...
    "taskTypeSixDimensionalSmartRouterActuator": "Task type → Six-weight router → Executor pool; band width represents the share of assigned tasks",
    "toEnter": ": incoming ",
    "andLeft": " · remaining ",
    "article": " tasks",
    ...
    "mixedUnitPriceForEachActuatorAnd": "Blended unit price and typical latency for each executor (normalized; lower is better)",
  },
} as const;
