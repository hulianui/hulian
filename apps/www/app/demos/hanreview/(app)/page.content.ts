...
export const content = {
  ...
  en: {
    ...
    "tip": "Tip",
    "overview": "Overview",
    "aiCodeReviewStatusAsOf": "AI Code Review Status · As of 06-05 14:30",
    "ofTheAiReviewBudgetHasAlready": "64% of the AI review budget has already been used this month, and at the current pace, it is expected to be fully used by the end of the month. The weighting of high-priced models can be lowered in the \"routing strategy.\"",
    "numberOfReviewsThisWeek": "Number of reviews this week",
    "averageMassScore": "Average mass score",
    "issuesToBeAddressed": "Issues to be addressed",
    "accessControlClearanceRate": "Gate pass rate",
    "qualityTrendNearlyDays": "Quality Trend · Nearly 30 days",
    ...
    "theHigherTheValueTheMoreNumerous": "The higher the value, the more numerous the problems",
    "valueValueValueQuestions": "{0} · {1}: {2} questions",
