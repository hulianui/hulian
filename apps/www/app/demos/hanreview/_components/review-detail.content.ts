...
export const content = {
  ...
  en: {
    ...
    "secondary": "Secondary",
    "tip": "Tip",
    "recommendationsHaveBeenAdopted": "Recommendations have been adopted",
    "valueValueModificationSuggestionsHaveBeenWritten": "{0}:{1} modification suggestions have been written to the workspace.",
    "resubmittedForReview": "Resubmitted for review",
    "reExamin": "Re-examin",
    "forcedMergeBypassAccessControl": "Forced merge (bypass the quality gate)",
    "merged": "Merged",
    "thisMergerBypassedAccessControlBlockingAnd": "This merge bypassed a blocking quality gate and was recorded in the audit log.",
    "valueAlreadyIn": "{0} Already in.",
    "forcedMerger": "Forced merger",
    "merged2": "Merged",
    ...
    "seriousIssueCanBeSafelyMerged": "% · Serious issue 0, can be safely merged.",
    "editFiles": "Edit files",
    "thereWereNoDocumentChangesDuringThis": "There were no document changes during this review.",
    "aiReviewProcess": "AI review process",
    "qualityPoints2": "Quality points",
    "summaryOfIssues": "Summary of issues",
    "leadReviewerModel": "Lead reviewer model",
    "codeCoverage": "Code coverage",
    "thisTimeTheCost": "This time, the cost",
