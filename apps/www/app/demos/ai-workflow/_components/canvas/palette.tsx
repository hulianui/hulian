import { copy } from "./palette.content";
import { Plus } from "lucide-react";
import { ScrollArea, Text, cn } from "@hulianui/ui";
import { ACCENT, NODE_KINDS, type NodeGroup } from "../../_data/node-kinds";
import type { NodeKind } from "../../_data/types";

const GROUPS: { key: NodeGroup; label: string }[] = [
  { key: "input", label: copy("input") },
  { key: "generate", label: copy("generate") },
  { key: "post-processing", label: copy("postProcessing") },
