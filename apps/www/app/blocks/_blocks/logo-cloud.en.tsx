      ...
      <div className="mx-auto w-full max-w-6xl px-6">
        ...
        <div className="mt-10 grid grid-cols-2 gap-px overflow-hidden rounded-[var(--radius)] border border-border bg-border sm:grid-cols-3 lg:grid-cols-5">
          {brands.map((brand) => {
            ...
            return (<div key={brand.name} className="group flex items-center justify-center gap-2.5 bg-background px-4 py-8 text-muted-foreground grayscale transition-all duration-200 hover:bg-surface/60 hover:text-foreground hover:grayscale-0">
