...
const LINES = [
  ...
  {
    text: "\uD83D\uDE80 Deployed successfully: https://my-app.hulian.app",
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-6 py-20 md:grid-cols-2 md:gap-10 md:py-28">
        <div className="flex flex-col items-start gap-6 text-left">
          ...
          <Text tone="muted" size="lg" className="max-w-md">
            No configuration or infrastructure maintenance. HanCloud CLI detects your framework,
            builds the app, and distributes it worldwide before your coffee is ready.
          </Text>
