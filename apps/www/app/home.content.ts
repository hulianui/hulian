...
export const homeContent = {
  "zh-CN": {
    ...
    builtWith: "用瑚琏搭的",
    abelName: "瑚琏 · Abel",
    abelBlurb: "全栈开发者个人站 · 产品 / UI / UX / 前后端",
    mockBlurb: "Mock 数据工作台 · 个人、账号、业务字段与接口响应",
  ...
  en: {
    ...
    builtWith: "Built with Hulian",
    abelName: "Hulian · Abel",
    abelBlurb: "Personal site of a full-stack indie developer.",
    mockBlurb: "Mock data workbench for profiles, accounts, fields, and API responses.",
