...
export const manifest: ComponentMeta[] = [
  ...
  { slug: "modal", name: "Modal", description: "命令式对话框 · confirm/info/success/error/warning 函数式 API + Dialog 引擎", category: "feedback", status: "new" },
  { slug: "notification", name: "Notification", description: "通知 · 四角堆叠卡片 + 图标/操作区/位置 + 命令式 API(比 Toast 重)", category: "feedback", status: "new" },
  { slug: "spin", name: "Spin", description: "加载遮罩 · 覆盖内容区 + tip + delay 防闪 + fullscreen", category: "feedback", status: "new" },
  ...
  { slug: "comment", name: "Comment", description: "评论 · 嵌套回复缩进 + 可选连接线 + 操作区 + comment/log 类型(复用 Avatar/Link·RSC)", category: "data-display", status: "new" },
