...
export const manifest: ComponentMeta[] = [
  ...
  { slug: "heatmap", name: "Heatmap", description: "热力图 · 网格色阶映射(value→bucket→primary 透明度档·纯函数 buildMatrix/bucketize 可测) + 小数值域 domain/valueFormat 百分比 + 色阶图例 + 行列标签 + 原生 hover 提示 + 点击下钻 · 代码热点/贡献活动/覆盖率·库内首个热力图", category: "data-display", group: "collection", status: "new" },
