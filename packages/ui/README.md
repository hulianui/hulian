...
> **English TL;DR** — A React component library with 397 components, built on Base UI's accessible behaviour layer and Tailwind CSS v4 OKLCH tokens: zero-flash theme switching and runtime re-skinning. It ships **source**, not a compiled bundle. English docs: <https://hulianui.haloritual.com/en>

颜值 + 好用的 React 设计系统 —— **397 个组件**，OKLCH 主题 · Tailwind v4 · 暗色零闪烁 · 运行时换肤。
