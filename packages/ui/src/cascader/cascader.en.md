...
> Cascading selector · Trigger with horizontal Popover columns, controlled path arrays, click/hover expansion, and `changeOnSelect`, built on the shared tree engine · forms/advanced
