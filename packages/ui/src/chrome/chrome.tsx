  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 border-b border-border bg-surface px-3 py-2">
        <div className="flex shrink-0 items-center gap-1 text-muted-foreground [&_svg]:size-4">
          {/* back */}
        ...
        <div className="flex min-w-0 flex-1 items-center gap-2 rounded-full bg-bg px-3 py-1 text-xs text-muted-foreground">
          {/* lock */}
