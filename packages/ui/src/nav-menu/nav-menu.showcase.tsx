    ...
    children: [
      {
        ...
        icon: <Users />,
        children: [
          { key: "users-list", label: "用户列表", href: "#" },
          { key: "users-roles", label: "角色权限", href: "#" },
          { key: "users-audit", label: "操作审计", href: "#" },
        ],
      },
      {
        key: "content",
        ...
        icon: <FileText />,
        children: [
          { key: "content-posts", label: "文章", href: "#" },
          {
    ...
    children: [
      {
        ...
        children: [
          ...
          { key: "sys-user-list", label: "用户列表", href: "#" },
        ],
      },
      {
        key: "sys-log",
        label: "日志",
        children: [
          { key: "sys-log-login", label: "登录日志", href: "#" },
          { key: "sys-log-error", label: "错误日志", href: "#" },
        ],
      },
    ],
  },
        ...
        children: [
          {
            ...
            label: "角色",
            children: [
              { key: "sys-user-role-list", label: "角色列表", href: "#" },
              { key: "sys-user-role-perm", label: "权限分配", href: "#" },
            ],
          },
        ],
      },
