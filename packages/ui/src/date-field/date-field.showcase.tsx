...
import type { DateFieldPicker } from "./date-field.types";
...
export const dateFieldShowcase: ShowcaseSpec = {
  examples: [
    {
      title: "基础用法",
      description: "点触发器弹出单月日历，选一天即提交并关闭。对外值是 ISO 日期串 YYYY-MM-DD。",
      code: `<DateField defaultValue="2026-06-08" />`,
    ...
    },
    {
      ...
      code: `<DateField picker="month" defaultValue="2026-06" />
<DateField picker="year" defaultValue="2026" />`,
      render: () => (
        <div className="flex flex-wrap gap-3">
          <DateField picker="month" defaultValue="2026-06" aria-label="选择月份" />
          <DateField picker="year" defaultValue="2026" aria-label="选择年份" />
        </div>
      ),
    },
    {
...
/>`,
    ...
    },
    {
      ...
      code: `<DateField defaultValue="2026-06-08" displayFormat="YYYY 年 M 月 D 日" />`,
      render: () => (
        <DateField defaultValue="2026-06-08" displayFormat="YYYY 年 M 月 D 日" aria-label="选择日期" />
      ),
    },
    {
      title: "禁用 / 只读",
      description: "disabled 整体置灰且打不开；readOnly 可以看面板但选不动。",
      code: `<DateField defaultValue="2026-06-08" disabled />
<DateField defaultValue="2026-06-08" readOnly />`,
      render: () => (
        <div className="flex flex-wrap gap-3">
          <DateField defaultValue="2026-06-08" disabled aria-label="禁用" />
          <DateField defaultValue="2026-06-08" readOnly aria-label="只读" />
        </div>
      ),
    },
  ],
  ...
  renderWithProps: (p) => (
    <Demo
      picker={(p.picker as DateFieldPicker) ?? "date"}
