      ...
      >
        <BaseCombobox.Popup
          className={cn(
            ...
            "flex max-h-[min(24rem,var(--available-height))] max-w-[min(32rem,var(--available-width))] min-w-[var(--anchor-width)] flex-col rounded-[var(--radius)] border border-hairline bg-surface p-1 text-foreground shadow-xl outline-none",
