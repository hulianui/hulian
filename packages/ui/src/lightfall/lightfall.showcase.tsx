...
export const lightfallShowcase: ShowcaseSpec = {
  examples: [
    {
      title: "基础用法",
      description: "组件自带 absolute inset-0 z-0，放进 relative 深色容器即可。",
  ...
  <div className="relative z-10 flex h-full items-center justify-center text-sm font-medium text-white/80">
    ...
    {
      title: "密集多束（暖橙调）",
      description: "streakCount 加束 + 自定义暖色 colors，density 调密。",
      code: `<div className="relative h-64 overflow-hidden rounded-xl"
     style={{ background: "oklch(0.13 0.02 265)" }}>
  <Lightfall
    streakCount={6}
  ...
  />
    ...
    {
      title: "壁纸级（慢速·长拖尾·无交互）",
      description: "speed 调慢 + streakLength 拉长，关 mouseInteraction 当静态背景。",
      code: `<div className="relative h-64 overflow-hidden rounded-xl"
     style={{ background: "oklch(0.13 0.02 265)" }}>
  <Lightfall
    speed={0.25}
  ...
  <div className="relative z-10 flex h-full flex-col items-center justify-center gap-2">
    ...
    {
      title: "稳定常亮（细光束）",
      description: "twinkle=0 关闭明暗呼吸，streakWidth 调细。",
      code: `<div className="relative h-64 overflow-hidden rounded-xl"
     style={{ background: "oklch(0.13 0.02 265)" }}>
