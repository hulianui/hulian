...
const toneClass = { command: "text-foreground", muted: "text-muted-foreground", success: "text-primary" } as const;
      ...
      <div className="flex flex-col gap-1 p-4">
        <LazyMotionProvider>
          {lines.map((line, i) => (
            ...
            >
              {line.prompt && <span className="select-none text-muted-foreground">{line.prompt}</span>}
