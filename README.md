...
<p align="center">
  颜值 + 好用的 React 设计系统 —— <b>396 个组件</b>，OKLCH 主题 · Tailwind v4 · 暗色零闪烁 · 运行时换肤。
</p>
...
- 🧩 **396 个组件** —— 基础控件 / 表单 / 数据展示 / 反馈 / 导航 / overlay / 图表 / 特效背景 / AI 智能体 / 直播 / 节点画布 …
...
- **组件库**：396 个组件，覆盖中后台、营销站、电商、AI 应用、移动端等场景 —— [浏览全部](https://hulianui.haloritual.com)
